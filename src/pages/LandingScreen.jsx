            ...
            <Grid container>
                ...
                <Grid item lg={12}>
                    <Box className={classes.heroText}>
                        <Typography variant='h4' style={{ fontWeight: '600' }}>Services we offer</Typography>
                    </Box>
                    <Box className={classes.serviceCard}>
                        <Grid container spacing={0} >
                            {services.map((cards) =>
                                <Grid item sm={6} xs={12} md={4}>
                                    <Box data-aos="zoom-in" className={classes.heroText}>
                ...
                <Divider className={classes.divider} style={{ marginTop: '5rem' }} />

                <Grid item lg={6} xs={12} md={6} className={classes.heroText} data-aos="fade-up">
                    <Box >
                        <img src={line} />
                        <Typography variant='h6' className={classes.lead}>Leading companies trust us<b> to develop software</b></Typography>
                        <Typography variant='subtitle1' className={classes.para}>
                        ...
                        <Typography className={classes.more}>See more informations
                        </Typography>
                    </Box>
                </Grid>
                ...
                <Grid item lg={12} xs={12} md={12} >
                    <Box className={classes.para2} data-aos="fade-up">
                        <img src={line} />
                ...
                <Divider style={{ backgroundColor: '#E7DAED', width: '100%', marginTop: '5rem' }} />

                {/* Our Team */}
                <Grid item lg={12} data-aos="fade-up">
                    <Box className={classes.heroText} style={{ marginTop: '7rem' }}>
                        <Box style={{ width: '50%', display: 'grid', justifyContent: 'center', alignItems: 'center' }}>
                            <img src={line} className={classes.colorLine} />
                            <Typography variant='h6' className={classes.teamHeading}>Why cutomers love<br />
                                <b>working with our Team</b></Typography>
                            <Typography className={classes.teamPara}>Without any doubt I recommend Alcaline Solutions as one of the best
                                web design and digital marketing agencies. One of the best agencies I’ve came across so far.
                                Wouldn’t be hesitated to introduce their work to someone else.</Typography>
                        </Box>
                    </Box>
                    <Grid lg={12} xs={12} className={classes.profileImg}>
                        <Box data-aos="fade-right" >
                            <img src={profileImg5} alt="company name" className={classes.profileImg1} />
                            <Box >
                                <img src={rating} alt='review' />
                                <Typography variant="h6" className={classes.employeName}>Romeena De Silva</Typography>
                                <Typography variant="h6" className={classes.employeRole}>Software Enginner</Typography>
                            </Box>
                        ...
                        <Box data-aos="fade-right">
                            ...
                            <Box>
                                <img src={rating} alt='review' />
                                <Typography variant="h6" className={classes.employeName}>Imran Khan</Typography>
                                <Typography variant="h6" className={classes.employeRole}>Software Enginner</Typography>
                            </Box>
                        </Box>
                        <Box data-aos="fade-left">
                ...
                {/* About Us Section */}
                <Grid item lg={6} md={6} xs={12} className={classes.About} >
                    <img src={about} alt='about' width="auto" />
                </Grid>
                <Grid item lg={6} md={6} xs={12} className={classes.About}>
...
const useStyles = makeStyles(() => ({
    ...
    employeName: {
        color: 'purple', fontWeight: '700', fontSize: '17px'
    },
    employeRole: {
        color: '#000',
        fontWeight: '700',
